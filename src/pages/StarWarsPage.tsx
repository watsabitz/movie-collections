...
const starWarsMovies: Movie[] = [
  ...
  },
  {
    ...
    year: 1983,
    description: "After rescuing Han Solo from Jabba the Hutt, the Rebels attempt to destroy the second Death Star.",
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold mb-8 text-center">Star Wars Movies</h1>
